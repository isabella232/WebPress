...
class Editor{
	...
	public function createEditor($editor){
		...
		$out .= '<textarea id="editing" class="form-control" spellcheck="false" onkeydown="check_tab(this, event);" oninput="syntaxHighlight(this.value); sync_scroll(this);" onscroll="sync_scroll(this);" onselect="selectedString(this);"></textarea>';
