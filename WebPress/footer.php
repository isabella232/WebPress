...
$footer .= '<script src="'.$basepath.DS.str_replace('{version}', $conf['bootstrap']['version'], $conf['bootstrap']['jsurl']).'"></script>';
$footer.= '<script src="'.$basepath.DS.str_replace('{version}', $conf['fontawesome']['version'], $conf['fontawesome']['jsurl']).'"></script>';
$footer.= '<script src="'.$basepath.DS.str_replace('{version}', $conf['notifyJS']['version'], $conf['notifyJS']['jsurl']).'"></script>';
$footer.='<script src="'.$basepath.DS.str_replace('{version}', $conf['prismJS']['version'], $conf['prismJS']['jsurl']).'"></script>';
